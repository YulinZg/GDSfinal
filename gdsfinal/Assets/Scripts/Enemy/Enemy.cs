...
public abstract class Enemy : MonoBehaviour
{
    ...
    void OnDrawGizmos()//绘制辅助线
    {
        ...
        Gizmos.DrawWireSphere((Vector2)transform.position, senseRadius);//绘制射线
                                                                        // Gizmos.DrawLine((Vector2)transform.position, (Vector2)transform.position + (new Vector2(moveDir.x, 0) + new Vector2(0, -1)) * senseRadius);//绘制圆形
    }
}
